...
{
    public partial class KluzkyLakList
    {
        private void List5_Startup(object sender, System.EventArgs e)
        {
        }
        public List<KluzkyLak> GetGranulaty()
        {
            ...
            for (int i = 0; i < worksheet.Rows.Count; i++)
            {
                ...
                list.Add(new KluzkyLak(name, aktivni, vyrobce, pouziti, nevhodneKombinace, slozeniDle, slozeni));
            }
        ...
        public List<String> GetSlozeni(int currentRow, int startingCollumn)
        {
            ...
            for (int i = startingCollumn; i <= 13; i++)
            {
